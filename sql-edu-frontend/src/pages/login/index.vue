    ...
    <view class="container">
      ...
      <view class="form-box">
        ...
        <template v-if="mode === 'login'">
          <input class="input" v-model="loginForm.email" type="text" :placeholder="t.placeholderEmailOrUser" />
          <input class="input" v-model="loginForm.password" type="password" :placeholder="t.placeholderPassword" />
          <button class="btn" @click="handleLogin" :loading="loading">{{ t.btnLogin }}</button>
        </template>

        <template v-else-if="mode === 'register'">
          <input class="input" v-model="registerForm.email" type="text" :placeholder="t.placeholderEmail" />
          <view class="row">
            <input class="input input-grow" v-model="registerForm.captcha" type="text" :placeholder="t.placeholderCaptcha" />
            <button class="btn-mini" :disabled="codeCountdown > 0" @click="handleGetCode">
              {{ codeCountdown > 0 ? `${codeCountdown}s` : t.getCode }}
            </button>
          </view>
          <input class="input" v-model="registerForm.username" type="text" :placeholder="t.placeholderUsername" />
          <input class="input" v-model="registerForm.password" type="password" :placeholder="t.placeholderPasswordRegister" />
          <input class="input" v-model="registerForm.confirm_password" type="password" :placeholder="t.placeholderConfirmPassword" />
          <input
            class="input"
        ...
        <template v-else-if="mode === 'delete'">
          ...
          <input class="input" v-model="deleteForm.email" type="text" :placeholder="t.placeholderEmailOrUser" />
          <input class="input" v-model="deleteForm.password" type="password" :placeholder="t.placeholderPasswordDelete" />
